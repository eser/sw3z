...
message. Do NOT retry with Bash. Instead use:
...
`ctx_fetch_and_index` instead. Instead use:
...
If you are reading a file to **Edit** it → Read is correct (Edit needs content
in context). If you are reading to **analyze, explore, or summarize** → use
...
**ALWAYS** update `CHANGELOG.md` when modifying the specification or any project
files. Follow [Keep a Changelog](https://keepachangelog.com/en/1.1.0/) format:

- **Added** — new features, fields, sections
- **Changed** — modifications to existing behavior or spec
- **Deprecated** — features marked for future removal
- **Removed** — deleted features or fields
- **Fixed** — corrections to errors, typos, or inconsistencies
- **Security** — vulnerability fixes or security-related changes

Place entries under `## [Unreleased]` at the top. When a version is released,
move unreleased entries into a versioned section with the date:
`## [X.Y.Z] - YYYY-MM-DD`.
